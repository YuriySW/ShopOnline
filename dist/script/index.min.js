...
/* harmony import */ var _modules_identifier_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(759);
...
/* harmony import */ var _identifier_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(759);


const loadGoods = async () => {
  try {
    if (_identifier_js__WEBPACK_IMPORTED_MODULE_1__/* .productCards */ .p3) _identifier_js__WEBPACK_IMPORTED_MODULE_1__/* .productCards */ .p3.innerHTML = '';
    const url = `${_identifier_js__WEBPACK_IMPORTED_MODULE_1__/* .BASE_URL */ .C1}/api/goods`;
    ...
    if (_identifier_js__WEBPACK_IMPORTED_MODULE_1__/* .productCards */ .p3) _identifier_js__WEBPACK_IMPORTED_MODULE_1__/* .productCards */ .p3.innerHTML = '';
    response.goods.forEach(_createElement_js__WEBPACK_IMPORTED_MODULE_0__/* .renderProductCard */ .Q2);
  } catch (error) {
...
/* harmony import */ var _identifier_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(759);
...
const loadCategoryGoods = async () => {
  ...
  if (_identifier_js__WEBPACK_IMPORTED_MODULE_2__/* .productCards */ .p3) _identifier_js__WEBPACK_IMPORTED_MODULE_2__/* .productCards */ .p3.innerHTML = '';
  try {
    const url = `${_identifier_js__WEBPACK_IMPORTED_MODULE_2__/* .BASE_URL */ .C1}/api/goods`;
    const result = await fetch(url);
    const response = await result.json();
    ...
    filteredGoods.forEach(_createElement_js__WEBPACK_IMPORTED_MODULE_1__/* .renderProductCard */ .Q2);
  } catch (error) {
    console.error('Ошибка при загрузке товаров:', error);
  }
};
  ...
  if (productId) {
    const loadCardGood = async productId => {
      try {
        ...
        (0,_createElement_js__WEBPACK_IMPORTED_MODULE_1__/* .renderCard */ .Tm)(good);
...
_identifier_js__WEBPACK_IMPORTED_MODULE_1__/* .basketBtn */ .hA.forEach(item => {
...
const imageSub = () => {
  ...
  const loadDeliveryImages = () => {
    ...
    basket.forEach(item => {
      const imageUrl = item.image ? `${_identifier_js__WEBPACK_IMPORTED_MODULE_1__/* .BASE_URL */ .C1}/${item.image}` : _identifier_js__WEBPACK_IMPORTED_MODULE_1__/* .DEFAULT_IMAGE */ .__;
    ...
    `;
      ...
      img.onerror = () => (0,_createElement_js__WEBPACK_IMPORTED_MODULE_0__/* .handleImageError */ .Us)(img);
    });
  };
...
const updateBasketCount = () => {
  ...
  _identifier_js__WEBPACK_IMPORTED_MODULE_1__/* .basketTitle */ .Lw.setAttribute('data-number', itemCount);
  _identifier_js__WEBPACK_IMPORTED_MODULE_1__/* .basketGoodsCount */ .kc.textContent = itemCount;
};
...
if (window.location.pathname.includes('basket.html')) {
  ...
  if (basket.length > 0) {
    ...
    basket.forEach(item => {
      ...
      (0,_createElement_js__WEBPACK_IMPORTED_MODULE_0__/* .basketRender */ .LG)(item.id, imageUrl, _identifier_js__WEBPACK_IMPORTED_MODULE_1__/* .DEFAULT_IMAGE */ .__, item.title, itemGood, newPrice, oldPriceSpan, basketList);
      imageSub();
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   LG: function() { return /* binding */ basketRender; },
/* harmony export */   Q2: function() { return /* binding */ renderProductCard; },
/* harmony export */   Tm: function() { return /* binding */ renderCard; },
/* harmony export */   Us: function() { return /* binding */ handleImageError; }
/* harmony export */ });
/* harmony import */ var _identifier_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(759);

const handleImageError = img => {
  img.src = _identifier_js__WEBPACK_IMPORTED_MODULE_0__/* .DEFAULT_IMAGE */ .__;
  const picture = img.closest('picture');
  if (picture) {
    picture.querySelectorAll('source').forEach(source => {
      source.srcset = _identifier_js__WEBPACK_IMPORTED_MODULE_0__/* .DEFAULT_IMAGE */ .__;
    });
  }
};
const renderProductCard = ({
  ...
  const imageUrl = image ? `${_identifier_js__WEBPACK_IMPORTED_MODULE_0__/* .BASE_URL */ .C1}/${image}` : _identifier_js__WEBPACK_IMPORTED_MODULE_0__/* .DEFAULT_IMAGE */ .__;
  ...
  const productHTML = `
   ...
   `;
  _identifier_js__WEBPACK_IMPORTED_MODULE_0__/* .productCards */ .p3.insertAdjacentHTML('beforeend', productHTML);
  const lastCard = _identifier_js__WEBPACK_IMPORTED_MODULE_0__/* .productCards */ .p3.lastElementChild;
...
const renderCard = ({
  ...
  const cardHtml = `
        ...
        `;
  _identifier_js__WEBPACK_IMPORTED_MODULE_0__/* .card */ .Nr.insertAdjacentHTML('beforeend', cardHtml);
  const img = document.querySelector('.card__image');
  img.onerror = () => handleImageError(img);
};
const basketRender = (itemId, imageUrl, defImg, itemTitle, itemGood, newPrice, oldPriceSpan, basketList) => {
  const itemHtml = `
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   C1: function() { return /* binding */ BASE_URL; },
/* harmony export */   Lw: function() { return /* binding */ basketTitle; },
/* harmony export */   Nr: function() { return /* binding */ card; },
/* harmony export */   __: function() { return /* binding */ DEFAULT_IMAGE; },
/* harmony export */   hA: function() { return /* binding */ basketBtn; },
/* harmony export */   kc: function() { return /* binding */ basketGoodsCount; },
/* harmony export */   p3: function() { return /* binding */ productCards; }
/* harmony export */ });
